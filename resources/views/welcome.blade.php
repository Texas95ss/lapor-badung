...
@if (session('login_success'))
    <div id="toast-success" class="fixed top-5 right-5 z-[9999] flex items-center w-full max-w-xs p-4 mb-4 text-gray-500 bg-white rounded-lg shadow-2xl border-l-4 border-green-500 transition-opacity duration-500 transform translate-y-0 opacity-100" role="alert">
        ...
        <div class="ml-3 text-sm font-bold text-gray-800">{{ session('login_success') }}</div>
